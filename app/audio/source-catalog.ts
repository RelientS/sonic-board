...
export const GUITAR_VOICES: Array<{ id: GuitarVoiceId; name: string; description: string }> = [
  { id: 'single-neck', name: '单线圈琴颈', description: '圆润、有空气感，适合合唱和长混响。' },
  { id: 'single-bridge', name: '单线圈琴桥', description: '明亮、拨弦清楚，延迟重复更容易听清。' },
  { id: 'humbucker', name: '双线圈', description: '厚实、输出更饱满，适合推动失真和法兹。' },
  { id: 'hollowbody', name: '空心爵士', description: '温暖、柔和，适合复古和低饱和度清音。' },
];
